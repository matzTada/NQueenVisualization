...
void updateCheckbox(int x, int y, int number) {//if tick : 1, delete : 1
...
void draw() {
  ...
  stroke(0, 255, 0);
  strokeWeight(4);
  ellipse((fingerx+adjuster_x)*gridsize, (fingery+adjuster_y)*gridsize, gridsize*0.9, gridsize*0.9);
  strokeWeight(1);
  noStroke();
